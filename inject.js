...
(function () {
    ...
    function attachMapRenderListeners(map) {
        ...
        // Continuously keep synced on animation frame
    ...
    function highlightErrorLocation(coord) {
        ...
        // Remove previous active marker element if any
    ...
    function zoomToErrorLocation(coord, targetZoom = 21) {
        ...
        // Hiển thị marker bóng đèn nháy màu đỏ tại tọa độ lỗi
        highlightErrorLocation(coord);

        // Lấy maxZoom của bản đồ nếu có (đảm bảo zoom cận cảnh tối đa)
        ...
        // Chuyển mượt bản đồ đến tọa độ lỗi với mức zoom cận cảnh lớn hơn (Zoom 21)
        try {
            view.animate({
                center: coord,
                zoom: finalZoom,
