// ============================================================
// 3DG Topology Checker — Core Algorithm Engine
...
(function () {
    ...
    // Euclidean distance squared between two 2D points [x, y]
    ...
    // Perpendicular distance squared from point P to segment AB
        ...
        function walk(layer) {
            ...
            try {
                ...
                for (const f of src.getFeatures()) {
                    ...
                    // Chỉ kiểm tra các đối tượng hình học dạng đường LineString / MultiLineString / Polygon
    ...
    function runTopologyCheck(options = {}) {
        ...
        // Build segment and vertex spatial index
        const allSegments = []; // { p1, p2, featureId, featureItem }
        const allVertices = []; // { point, featureId, isEndpoint, featureItem }
